...
class AuditsEdit extends StatefulWidget {
  const AuditsEdit({
    super.key,
  ...
  @override
  State<AuditsEdit> createState() => _AuditsEditState();
}

class _AuditsEditState extends State<AuditsEdit> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Audits");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Audits");
    }
  }
