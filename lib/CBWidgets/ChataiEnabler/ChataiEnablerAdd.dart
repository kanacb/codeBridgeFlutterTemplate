...
class ChataiEnablerAdd extends StatefulWidget {
  const ChataiEnablerAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<ChataiEnablerAdd> createState() => _ChataiEnablerAddState();
}

class _ChataiEnablerAddState extends State<ChataiEnablerAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Chatai Enabler");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Chatai Enabler");
    }
  }
