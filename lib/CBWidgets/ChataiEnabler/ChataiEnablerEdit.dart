...
class ChataiEnablerEdit extends StatefulWidget {
  const ChataiEnablerEdit({
    super.key,
  ...
  final ChataiEnabler data;
  final String? name;
	final String? serviceName;
	final String? description;

  @override
  State<ChataiEnablerEdit> createState() => _ChataiEnablerEditState();
}

class _ChataiEnablerEditState extends State<ChataiEnablerEdit> {
  ...
  void saveForm() async {
    ChataiEnablerProvider provider = ChataiEnablerProvider();
    // Handle form submission logic here
    final data = ChataiEnabler.fromJson(formData);
    Response response = await provider.updateOneAndSave(data.id!, data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Chatai Enabler");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Chatai Enabler");
    }
  }
