...
class ChataiPromptsAdd extends StatefulWidget {
  const ChataiPromptsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<ChataiPromptsAdd> createState() => _ChataiPromptsAddState();
}

class _ChataiPromptsAddState extends State<ChataiPromptsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Chatai Prompts");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Chatai Prompts");
    }
  }
