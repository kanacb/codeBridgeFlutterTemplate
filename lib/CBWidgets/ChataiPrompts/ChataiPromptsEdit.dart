...
class ChataiPromptsEdit extends StatefulWidget {
  const ChataiPromptsEdit({
    super.key,
  ...
  @override
  State<ChataiPromptsEdit> createState() => _ChataiPromptsEditState();
}

class _ChataiPromptsEditState extends State<ChataiPromptsEdit> {
  ...
  void saveForm() async {
    ChataiPromptsProvider provider = ChataiPromptsProvider();
    // Handle form submission logic here
    final data = ChataiPrompt.fromJson(formData);
    Response response = await provider.updateOneAndSave(data.id!, data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Chatai Prompts");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Chatai Prompts");
    }
  }
