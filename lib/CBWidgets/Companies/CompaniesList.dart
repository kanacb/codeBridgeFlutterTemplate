...
class _CompaniesListState extends State<CompaniesList> {
  ...
  AppBar _buildAppBar() {
    return AppBar(
      title: const Text('Companies Details'),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, CompaniesAdd(resource: schemaResponse?.data)));
            },
        ...
        children: [
          ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                Text('Name: ${item.name}'),
Text('Company no: ${item.companyNo}'),
Text('New company number: ${item.newCompanyNumber}'),
Text('Date Incorporated: ${item.DateIncorporated}'),
