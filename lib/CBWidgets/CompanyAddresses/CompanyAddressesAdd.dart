...
class CompanyAddressesAdd extends StatefulWidget {
  const CompanyAddressesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<CompanyAddressesAdd> createState() => _CompanyAddressesAddState();
}

class _CompanyAddressesAddState extends State<CompanyAddressesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Company Addresses");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Company Addresses");
    }
  }
