...
import 'CompanyAddressesMain.dart';
  
class CompanyAddressesEdit extends StatefulWidget {
  const CompanyAddressesEdit({
    super.key,
  ...
  final CompanyAddresses data;
  final String companyId;,

  @override
  State<CompanyAddressesEdit> createState() => _CompanyAddressesEditState();
}

class _CompanyAddressesEditState extends State<CompanyAddressesEdit> {
  ...
  void saveForm() async {
    CompanyAddressesProvider provider = CompanyAddressesProvider();
    // Handle form submission logic here
    final data = CompanyAddresses.fromJson(formData);
    Response response = await provider.updateOneAndSave(data.machineId!, data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Company Addresses");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Company Addresses");
    }
  }
