...
class CompanyPhonesAdd extends StatefulWidget {
  const CompanyPhonesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<CompanyPhonesAdd> createState() => _CompanyPhonesAddState();
}

class _CompanyPhonesAddState extends State<CompanyPhonesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Company Phones");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Company Phones");
    }
  }
