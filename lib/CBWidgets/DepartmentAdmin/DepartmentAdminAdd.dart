...
class DepartmentAdminAdd extends StatefulWidget {
  const DepartmentAdminAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<DepartmentAdminAdd> createState() => _DepartmentAdminAddState();
}

class _DepartmentAdminAddState extends State<DepartmentAdminAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Department Admin");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Department Admin");
    }
  }
