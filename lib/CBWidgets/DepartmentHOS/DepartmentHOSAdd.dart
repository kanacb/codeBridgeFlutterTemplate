...
class DepartmentHOSAdd extends StatefulWidget {
  const DepartmentHOSAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<DepartmentHOSAdd> createState() => _DepartmentHOSAddState();
}

class _DepartmentHOSAddState extends State<DepartmentHOSAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Department Hos");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Department Hos");
    }
  }
