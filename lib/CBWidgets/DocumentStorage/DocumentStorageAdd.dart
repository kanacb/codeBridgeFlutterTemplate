...
class DocumentStorageAdd extends StatefulWidget {
  const DocumentStorageAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<DocumentStorageAdd> createState() => _DocumentStorageAddState();
}

class _DocumentStorageAddState extends State<DocumentStorageAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Document Storage");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Document Storage");
    }
  }
