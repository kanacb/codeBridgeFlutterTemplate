...
class DocumentStoragesAdd extends StatefulWidget {
  const DocumentStoragesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<DocumentStoragesAdd> createState() => _DocumentStoragesAddState();
}

class _DocumentStoragesAddState extends State<DocumentStoragesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Document Storages");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Document Storages");
    }
  }
