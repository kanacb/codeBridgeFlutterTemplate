...
class EmployeesAdd extends StatefulWidget {
  const EmployeesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<EmployeesAdd> createState() => _EmployeesAddState();
}

class _EmployeesAddState extends State<EmployeesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Employees");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Employees");
    }
  }
