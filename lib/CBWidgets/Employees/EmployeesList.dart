...
class _EmployeesListState extends State<EmployeesList> {
  ...
  Future<void> _fetchSchema() async {
    schemaResponse = await EmployeesProvider().schema();
    setState(() {});
  }
  ...
  Future<void> _delete(String id, bool confirm) async {
    if (confirm) {
      ...
      if (response.isSuccess) {
        ...
        setState(() {
          provider.loadEmployeesFromHive();
        });
      } else {
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, EmployeesAdd(resource: schemaResponse?.data)));
            },
