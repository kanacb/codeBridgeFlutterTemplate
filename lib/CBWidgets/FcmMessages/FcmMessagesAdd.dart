...
class FcmMessagesAdd extends StatefulWidget {
  const FcmMessagesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<FcmMessagesAdd> createState() => _FcmMessagesAddState();
}

class _FcmMessagesAddState extends State<FcmMessagesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Fcm Messages");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Fcm Messages");
    }
  }
