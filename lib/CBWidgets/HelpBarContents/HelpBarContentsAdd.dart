...
class HelpBarContentsAdd extends StatefulWidget {
  const HelpBarContentsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<HelpBarContentsAdd> createState() => _HelpBarContentsAddState();
}

class _HelpBarContentsAddState extends State<HelpBarContentsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Help Bar Contents");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Help Bar Contents");
    }
  }
