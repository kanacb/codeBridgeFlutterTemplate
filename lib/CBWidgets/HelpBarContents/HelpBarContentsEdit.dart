...
class HelpBarContentsEdit extends StatefulWidget {
  const HelpBarContentsEdit({
    super.key,
  ...
  final HelpBarContent data;
  final String? serviceName;
	final String content;

  @override
  State<HelpBarContentsEdit> createState() => _HelpBarContentsEditState();
}

class _HelpBarContentsEditState extends State<HelpBarContentsEdit> {
  ...
  void saveForm() async {
    HelpBarContentsProvider provider = HelpBarContentsProvider();
    // Handle form submission logic here
    final data = HelpBarContent.fromJson(formData);
    Response response = await provider.updateOneAndSave(data.id!, data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Help Bar Contents");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Help Bar Contents");
    }
  }
