...
class HelpSidebarContentsAdd extends StatefulWidget {
  const HelpSidebarContentsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<HelpSidebarContentsAdd> createState() => _HelpSidebarContentsAddState();
}

class _HelpSidebarContentsAddState extends State<HelpSidebarContentsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Help Sidebar Contents");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Help Sidebar Contents");
    }
  }
