...
class InboxAdd extends StatefulWidget {
  const InboxAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<InboxAdd> createState() => _InboxAddState();
}

class _InboxAddState extends State<InboxAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Inbox");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Inbox");
    }
  }
