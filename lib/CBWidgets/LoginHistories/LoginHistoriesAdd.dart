...
class LoginHistoriesAdd extends StatefulWidget {
  const LoginHistoriesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<LoginHistoriesAdd> createState() => _LoginHistoriesAddState();
}

class _LoginHistoriesAddState extends State<LoginHistoriesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Login Histories");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Login Histories");
    }
  }
