...
class MailQuesEdit extends StatefulWidget {
  const MailQuesEdit({
    super.key,
  ...
  @override
  State<MailQuesEdit> createState() => _MailQuesEditState();
}

class _MailQuesEditState extends State<MailQuesEdit> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Mail Ques");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Mail Ques");
    }
  }
