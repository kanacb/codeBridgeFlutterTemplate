...
class PermissionFieldsAdd extends StatefulWidget {
  const PermissionFieldsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<PermissionFieldsAdd> createState() => _PermissionFieldsAddState();
}

class _PermissionFieldsAddState extends State<PermissionFieldsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Permission Fields");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Permission Fields");
    }
  }
