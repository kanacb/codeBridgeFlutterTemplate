...
class PermissionFieldsEdit extends StatefulWidget {
  const PermissionFieldsEdit({
    super.key,
  ...
  @override
  State<PermissionFieldsEdit> createState() => _PermissionFieldsEditState();
}

class _PermissionFieldsEditState extends State<PermissionFieldsEdit> {
  ...
  void saveForm() async {
    PermissionFieldsProvider provider = PermissionFieldsProvider();
    // Handle form submission logic here
    final data = PermissionField.fromJson(formData);
    Response response = await provider.updateOneAndSave(data.id!, data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Permission Fields");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Permission Fields");
    }
  }
