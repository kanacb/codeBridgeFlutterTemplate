...
class PermissionServicesAdd extends StatefulWidget {
  const PermissionServicesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<PermissionServicesAdd> createState() => _PermissionServicesAddState();
}

class _PermissionServicesAddState extends State<PermissionServicesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Permission Services");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Permission Services");
    }
  }
