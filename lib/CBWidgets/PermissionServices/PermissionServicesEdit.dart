...
class PermissionServicesEdit extends StatefulWidget {
  const PermissionServicesEdit({
    super.key,
  ...
  @override
  State<PermissionServicesEdit> createState() => _PermissionServicesEditState();
}

class _PermissionServicesEditState extends State<PermissionServicesEdit> {
  ...
  void saveForm() async {
    PermissionServicesProvider provider = PermissionServicesProvider();
    // Handle form submission logic here
    final data = PermissionService.fromJson(formData);
    Response response = await provider.updateOneAndSave(data.id!, data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Permission Services");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Permission Services");
    }
  }
