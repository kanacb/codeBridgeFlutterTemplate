...
class ProfileMenuEdit extends StatefulWidget {
  const ProfileMenuEdit({
    super.key,
  ...
  @override
  State<ProfileMenuEdit> createState() => _ProfileMenuEditState();
}

class _ProfileMenuEditState extends State<ProfileMenuEdit> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Profile Menu");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Profile Menu");
    }
  }
