...
class ProfilesAdd extends StatefulWidget {
  const ProfilesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<ProfilesAdd> createState() => _ProfilesAddState();
}

class _ProfilesAddState extends State<ProfilesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Profiles");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Profiles");
    }
  }
