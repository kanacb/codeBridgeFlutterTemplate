...
class _ProfilesListState extends State<ProfilesList> {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<ProfilesProvider>(context);
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, ProfilesAdd(resource: schemaResponse?.data)));
            },
                  ...
                  onPressed: () {
                    Navigator.of(context).push(Utils().createRoute(
                        ...
                        ProfilesEdit(
                          ...
                          data: item,
                          name : item.name,image : item.image,department : item.department,hod : item.hod,hos : item.hos,position : item.position,company : item.company
                        )));
                  },
                ),
                IconButton(
