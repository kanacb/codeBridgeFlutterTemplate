...
class RolesAdd extends StatefulWidget {
  const RolesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<RolesAdd> createState() => _RolesAddState();
}

class _RolesAddState extends State<RolesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Roles");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Roles");
    }
  }
