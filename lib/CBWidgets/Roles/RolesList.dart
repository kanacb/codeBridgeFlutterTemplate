...
class _RolesListState extends State<RolesList> {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<RolesProvider>(context);
  ...
  AppBar _buildAppBar() {
    return AppBar(
      title: const Text('Roles Details'),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, RolesAdd(resource: schemaResponse?.data)));
            },
