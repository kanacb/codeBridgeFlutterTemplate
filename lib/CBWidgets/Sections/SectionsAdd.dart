...
class SectionsAdd extends StatefulWidget {
  const SectionsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<SectionsAdd> createState() => _SectionsAddState();
}

class _SectionsAddState extends State<SectionsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Sections");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Sections");
    }
  }
