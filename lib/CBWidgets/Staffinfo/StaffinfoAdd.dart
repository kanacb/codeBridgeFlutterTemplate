...
class StaffinfoAdd extends StatefulWidget {
  const StaffinfoAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<StaffinfoAdd> createState() => _StaffinfoAddState();
}

class _StaffinfoAddState extends State<StaffinfoAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Staffinfo");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Staffinfo");
    }
  }
