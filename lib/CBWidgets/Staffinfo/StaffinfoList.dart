...
Text('Name: ${item.name}'),
Text('Name NRIC: ${item.nameNric}'),
Text('Comp Code: ${item.compCode}'),
Text('Comp Name: ${item.compName}'),
Text('Dept Code: ${item.deptCode}'),
Text('Dept Desc: ${item.deptDesc}'),
Text('Sect Code: ${item.sectCode}'),
Text('Sect Desc: ${item.sectDesc}'),
Text('Designation: ${item.designation}'),
Text('Email: ${item.email}'),
Text('Resign: ${item.resign}'),
Text('Supervisor: ${item.supervisor}'),
Text('Date Join: ${item.dateJoin}'),
Text('Emp Group: ${item.empGroup}'),
Text('Emp Grade Code: ${item.empGradeCode}'),
Text('Termination Date: ${item.terminationDate}'),
              ],
            ),
            trailing: Row(
