...
class StepsAdd extends StatefulWidget {
  const StepsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<StepsAdd> createState() => _StepsAddState();
}

class _StepsAddState extends State<StepsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Steps");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Steps");
    }
  }
