...
class _StepsListState extends State<StepsList> {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<StepsProvider>(context);
  ...
  AppBar _buildAppBar() {
    return AppBar(
      title: const Text('Steps Details'),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, StepsAdd(resource: schemaResponse?.data)));
            },
