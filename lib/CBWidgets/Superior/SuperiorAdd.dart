...
class SuperiorAdd extends StatefulWidget {
  const SuperiorAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<SuperiorAdd> createState() => _SuperiorAddState();
}

class _SuperiorAddState extends State<SuperiorAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Superior");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Superior");
    }
  }
