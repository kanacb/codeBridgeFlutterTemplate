...
import 'SuperiorAdd.dart';
import 'SuperiorEdit.dart';
import 'SuperiorProvider.dart';


class SuperiorList extends StatefulWidget {
  const SuperiorList({super.key});

  @override
  State<SuperiorList> createState() => _SuperiorListState();
}

class _SuperiorListState extends State<SuperiorList> {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<SuperiorProvider>(context);
  ...
  AppBar _buildAppBar() {
    return AppBar(
      title: const Text('Superior Details'),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, SuperiorAdd(resource: schemaResponse?.data)));
            },
