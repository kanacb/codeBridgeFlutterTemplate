...
class SuperiorsEdit extends StatefulWidget {
  const SuperiorsEdit({
    super.key,
  ...
  @override
  State<SuperiorsEdit> createState() => _SuperiorsEditState();
}

class _SuperiorsEditState extends State<SuperiorsEdit> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Superiors");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Superiors");
    }
  }
