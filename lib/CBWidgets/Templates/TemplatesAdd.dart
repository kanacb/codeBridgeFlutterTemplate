...
class TemplatesAdd extends StatefulWidget {
  const TemplatesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<TemplatesAdd> createState() => _TemplatesAddState();
}

class _TemplatesAddState extends State<TemplatesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Templates");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Templates");
    }
  }
