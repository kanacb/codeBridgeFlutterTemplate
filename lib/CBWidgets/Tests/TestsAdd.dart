...
class TestsAdd extends StatefulWidget {
  const TestsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<TestsAdd> createState() => _TestsAddState();
}

class _TestsAddState extends State<TestsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Tests");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Tests");
    }
  }
