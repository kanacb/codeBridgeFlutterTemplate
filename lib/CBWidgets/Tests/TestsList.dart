...
class _TestsListState extends State<TestsList> {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<TestsProvider>(context);
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, TestsAdd(resource: schemaResponse?.data)));
            },
...
Text('Passed: ${item.passed}'),
Text('Failed: ${item.failed}'),
