...
class UploaderEdit extends StatefulWidget {
  const UploaderEdit({
    super.key,
  ...
  @override
  State<UploaderEdit> createState() => _UploaderEditState();
}

class _UploaderEditState extends State<UploaderEdit> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Uploader");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Uploader");
    }
  }
