...
class UserChangePasswordEdit extends StatefulWidget {
  const UserChangePasswordEdit({
    super.key,
  ...
  @override
  State<UserChangePasswordEdit> createState() => _UserChangePasswordEditState();
}

class _UserChangePasswordEditState extends State<UserChangePasswordEdit> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated User Change Password");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update User Change Password");
    }
  }
