...
class UserGuideAdd extends StatefulWidget {
  const UserGuideAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<UserGuideAdd> createState() => _UserGuideAddState();
}

class _UserGuideAddState extends State<UserGuideAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added User Guide");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add User Guide");
    }
  }
