...
class UserGuideStepsAdd extends StatefulWidget {
  const UserGuideStepsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<UserGuideStepsAdd> createState() => _UserGuideStepsAddState();
}

class _UserGuideStepsAddState extends State<UserGuideStepsAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added User Guide Steps");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add User Guide Steps");
    }
  }
