...
class UserPhonesAdd extends StatefulWidget {
  const UserPhonesAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<UserPhonesAdd> createState() => _UserPhonesAddState();
}

class _UserPhonesAddState extends State<UserPhonesAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added User Phones");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add User Phones");
    }
  }
