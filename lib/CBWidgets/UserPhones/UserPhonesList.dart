...
class UserPhonesList extends StatefulWidget {
  const UserPhonesList({super.key});

  @override
  State<UserPhonesList> createState() => _UserPhonesListState();
}

class _UserPhonesListState extends State<UserPhonesList> {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<UserPhonesProvider>(context);
  ...
  AppBar _buildAppBar() {
    return AppBar(
      title: const Text('UserPhones Details'),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, UserPhonesAdd(resource: schemaResponse?.data)));
            },
