...
class UserTrackerIdAdd extends StatefulWidget {
  const UserTrackerIdAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<UserTrackerIdAdd> createState() => _UserTrackerIdAddState();
}

class _UserTrackerIdAddState extends State<UserTrackerIdAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added User Tracker Id");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add User Tracker Id");
    }
  }
