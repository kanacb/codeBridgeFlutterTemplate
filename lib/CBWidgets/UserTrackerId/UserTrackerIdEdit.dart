...
class UserTrackerIdEdit extends StatefulWidget {
  const UserTrackerIdEdit({
    super.key,
  ...
  @override
  State<UserTrackerIdEdit> createState() => _UserTrackerIdEditState();
}

class _UserTrackerIdEditState extends State<UserTrackerIdEdit> {
  ...
  void saveForm() async {
    UserTrackerIdProvider provider = UserTrackerIdProvider();
    // Handle form submission logic here
    final data = UserTrackerId.fromJson(formData);
    Response response = await provider.updateOneAndSave(data.id!, data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated User Tracker Id");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update User Tracker Id");
    }
  }
