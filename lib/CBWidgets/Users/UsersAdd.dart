...
class UsersAdd extends StatefulWidget {
  const UsersAdd({super.key, required this.resource});
...
class _UsersAddState extends State<UsersAdd> {
  ...
  void saveForm() async {
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully added Users");
    } else {
      snackBar.FailedSnackBar(context, "Failed to add Users");
    }
  }
