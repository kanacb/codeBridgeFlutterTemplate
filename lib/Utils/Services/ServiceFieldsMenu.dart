...
class ServiceFieldsMenu extends StatefulWidget {
  const ServiceFieldsMenu({super.key, required this.show, this.response});
  final bool show;
  final List<Schema>? response;

  @override
  State<ServiceFieldsMenu> createState() => _ServiceFieldsMenu();
}

class _ServiceFieldsMenu extends State<ServiceFieldsMenu> {
