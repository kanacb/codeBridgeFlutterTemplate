...
class AtlasChecklistsEdit extends StatefulWidget {
  const AtlasChecklistsEdit({
    super.key,
    required this.resource,
    required this.checklist,
  });
  final List<Schema> resource;
  final AtlasChecklists checklist;

  @override
  State<AtlasChecklistsEdit> createState() => _AtlasChecklistsEditState();
}

class _AtlasChecklistsEditState extends State<AtlasChecklistsEdit> {
