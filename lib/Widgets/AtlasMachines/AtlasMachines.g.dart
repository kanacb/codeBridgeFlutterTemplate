...
part of 'AtlasMachines.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class AtlasMachinesAdapter extends TypeAdapter<AtlasMachines> {
  @override
  final int typeId = 42;

  @override
  AtlasMachines read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, AtlasMachines obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.id)
