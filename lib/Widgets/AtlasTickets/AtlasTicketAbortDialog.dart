...
class AtlasTicketAbortDialog extends StatefulWidget {
  final AtlasTicket ticket;
  final VoidCallback onUpdated;
  final VoidCallback onHide;

  const AtlasTicketAbortDialog({
    super.key,
  ...
  @override
  State<AtlasTicketAbortDialog> createState() => _AtlasTicketAbortDialogState();
}

class _AtlasTicketAbortDialogState extends State<AtlasTicketAbortDialog> {
