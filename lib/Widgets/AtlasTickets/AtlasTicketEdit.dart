...
class AtlasTicketEdit extends StatefulWidget {
  const AtlasTicketEdit({
    super.key,
    required this.resource,
    required this.ticket, required atlasTicket,
  });
  final List<Schema> resource;
  final AtlasTicket ticket;

  @override
  State<AtlasTicketEdit> createState() => _AtlasTicketEditState();
}

class _AtlasTicketEditState extends State<AtlasTicketEdit> {
  ...
  void saveForm() async {
    ...
    AtlasTicketProvider ticketProvider = AtlasTicketProvider();
    ...
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully updated Atlas ticket");
    } else {
      snackBar.FailedSnackBar(context, "Failed to update Atlas ticket");
    }
  }
