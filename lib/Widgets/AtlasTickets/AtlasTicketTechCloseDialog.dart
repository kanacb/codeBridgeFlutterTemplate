...
class AtlasTicketTechCloseDialog extends StatefulWidget {
  final AtlasTicket ticket;
  final VoidCallback onUpdated;
  final VoidCallback onHide;

  const AtlasTicketTechCloseDialog({
    super.key,
  ...
  @override
  State<AtlasTicketTechCloseDialog> createState() => _AtlasTicketTechCloseDialogState();
}

class _AtlasTicketTechCloseDialogState extends State<AtlasTicketTechCloseDialog> {
    ...
    try {
      ...
      if (responseUpload.error == null) {
        ...
        final updatedData = {
          ...
          'technicianComments': _comments,
          'uploadOfPictureAfterRepair': _uploadOfPictureAfterRepairIds,
        };

        final Response responseTicket = await AtlasTicketProvider().patchOneAndSave(widget.ticket.id!, updatedData);
