...
class AtlasTicketTechOpenDialog extends StatefulWidget {
  final AtlasTicket ticket;
  final VoidCallback onUpdated;
  final VoidCallback onHide;

  const AtlasTicketTechOpenDialog({
    super.key,
  ...
  @override
  State<AtlasTicketTechOpenDialog> createState() => _AtlasTicketTechOpenDialogState();
}

class _AtlasTicketTechOpenDialogState extends State<AtlasTicketTechOpenDialog> {
