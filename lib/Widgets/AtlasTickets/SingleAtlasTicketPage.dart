...
class SingleAtlasTicketPage extends StatefulWidget {
  final AtlasTicket ticket;
  final AtlasMachines? machine;

  const SingleAtlasTicketPage({
    super.key,
  ...
  @override
  State<SingleAtlasTicketPage> createState() => _SingleAtlasTicketPageState();
}

class _SingleAtlasTicketPageState extends State<SingleAtlasTicketPage> {

  late final AtlasTicket _ticket;
  late final AtlasMachines? _machine;
  ...
  Future<void> _loadDocumentStorages(AtlasTicket ticket) async {
  ...
  void _copyPageLink() {
    final link = 'app://atlasTickets/${widget.ticket.id}';
                ...
                if (constraints.maxWidth > 900) {
                  return Row(
                    ...
                    children: [
                      ...
                      Expanded(child: _buildVendingControllerCard()),
                      const SizedBox(width: 16),
  ...
  Widget _buildVendingControllerCard() {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildInfoRow('Vending Controller', _ticket.vendingController?.name ?? 'N/A'),
            ...
            _buildInfoRow('Comment', _ticket.comments?.isNotEmpty == true
                ? _ticket.comments!
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // todo when webapp implements this
              // _buildInfoRow('Opening Remarks', _ticket.openingRemarks?.isNotEmpty == true
              //     ? _ticket.openingRemarks!
              //     : 'No comment available'),
              _buildInfoRow('Closing Remarks', _ticket.technicianComments?.isNotEmpty == true
                  ? _ticket.technicianComments!
                  : 'No comment available'),
            ],
          ),
        ),
