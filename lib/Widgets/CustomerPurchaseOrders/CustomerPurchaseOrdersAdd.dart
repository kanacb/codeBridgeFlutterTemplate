...
class CustomerPurchaseOrdersAdd extends StatefulWidget {
  const CustomerPurchaseOrdersAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<CustomerPurchaseOrdersAdd> createState() => _CustomerPurchaseOrdersAddState();
}

class _CustomerPurchaseOrdersAddState extends State<CustomerPurchaseOrdersAdd> {
  ...
  void saveForm() async {
    ...
    CustomerPurchaseOrdersProvider externalTicketProvider = CustomerPurchaseOrdersProvider();
