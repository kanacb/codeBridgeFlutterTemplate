...
class CustomerPurchaseOrdersEdit extends StatefulWidget {
  const CustomerPurchaseOrdersEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final CustomerPurchaseOrders ticket;

  @override
  State<CustomerPurchaseOrdersEdit> createState() => _CustomerPurchaseOrdersEditState();
}

class _CustomerPurchaseOrdersEditState extends State<CustomerPurchaseOrdersEdit> {
  ...
  void saveForm() async {
    ...
    CustomerPurchaseOrdersProvider ticketProvider = CustomerPurchaseOrdersProvider();
    // Handle form submission logic here
    final data = CustomerPurchaseOrders.fromJson(formData);
