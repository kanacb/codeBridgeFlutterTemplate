...
class CustomerSalesOrdersAdd extends StatefulWidget {
  const CustomerSalesOrdersAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<CustomerSalesOrdersAdd> createState() => _CustomerSalesOrdersAddState();
}

class _CustomerSalesOrdersAddState extends State<CustomerSalesOrdersAdd> {
  ...
  void saveForm() async {
    ...
    CustomerSalesOrdersProvider externalTicketProvider = CustomerSalesOrdersProvider();
    // Handle form submission logic here
    final data = CustomerSalesOrders.fromJson(formData);
