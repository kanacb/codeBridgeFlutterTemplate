...
class CustomerSalesOrdersEdit extends StatefulWidget {
  const CustomerSalesOrdersEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final CustomerSalesOrders ticket;

  @override
  State<CustomerSalesOrdersEdit> createState() => _CustomerSalesOrdersEditState();
}

class _CustomerSalesOrdersEditState extends State<CustomerSalesOrdersEdit> {
  ...
  void saveForm() async {
    ...
    CustomerSalesOrdersProvider ticketProvider = CustomerSalesOrdersProvider();
