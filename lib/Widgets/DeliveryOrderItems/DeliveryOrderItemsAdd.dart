...
class DeliveryOrderItemsAdd extends StatefulWidget {
  const DeliveryOrderItemsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<DeliveryOrderItemsAdd> createState() => _DeliveryOrderItemsAddState();
}

class _DeliveryOrderItemsAddState extends State<DeliveryOrderItemsAdd> {
  ...
  void saveForm() async {
    ...
    DeliveryOrderItemsProvider externalTicketProvider = DeliveryOrderItemsProvider();
    // Handle form submission logic here
    final data = DeliveryOrderItems.fromJson(formData);
