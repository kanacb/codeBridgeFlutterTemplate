...
class DeliveryOrderItemsEdit extends StatefulWidget {
  const DeliveryOrderItemsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final DeliveryOrderItems ticket;

  @override
  State<DeliveryOrderItemsEdit> createState() => _DeliveryOrderItemsEditState();
}

class _DeliveryOrderItemsEditState extends State<DeliveryOrderItemsEdit> {
  ...
  void saveForm() async {
    ...
    DeliveryOrderItemsProvider ticketProvider = DeliveryOrderItemsProvider();
