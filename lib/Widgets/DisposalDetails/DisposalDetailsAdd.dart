...
class DisposalDetailsAdd extends StatefulWidget {
  const DisposalDetailsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<DisposalDetailsAdd> createState() => _DisposalDetailsAddState();
}

class _DisposalDetailsAddState extends State<DisposalDetailsAdd> {
  ...
  void saveForm() async {
    ...
    DisposalDetailsProvider externalTicketProvider = DisposalDetailsProvider();
    // Handle form submission logic here
    final data = DisposalDetails.fromJson(formData);
