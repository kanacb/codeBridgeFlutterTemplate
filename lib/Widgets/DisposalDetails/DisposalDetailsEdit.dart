...
class DisposalDetailsEdit extends StatefulWidget {
  const DisposalDetailsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final DisposalDetails ticket;

  @override
  State<DisposalDetailsEdit> createState() => _DisposalDetailsEditState();
}

class _DisposalDetailsEditState extends State<DisposalDetailsEdit> {
  ...
  void saveForm() async {
    ...
    DisposalDetailsProvider ticketProvider = DisposalDetailsProvider();
