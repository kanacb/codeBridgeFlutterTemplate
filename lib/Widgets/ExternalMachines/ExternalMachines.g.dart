...
part of 'ExternalMachines.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ExternalMachinesAdapter extends TypeAdapter<ExternalMachines> {
  @override
  final int typeId = 45;

  @override
  ExternalMachines read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ExternalMachines obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is ExternalMachinesAdapter &&
