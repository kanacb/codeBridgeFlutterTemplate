...
class ExternalTicketsAdd extends StatefulWidget {
  const ExternalTicketsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<ExternalTicketsAdd> createState() => _ExternalTicketsAddState();
}

class _ExternalTicketsAddState extends State<ExternalTicketsAdd> {
  ...
  void saveForm() async {
    ...
    ExternalTicketsProvider externalTicketsProvider = ExternalTicketsProvider();
    // Handle form submission logic here
    final data = ExternalTickets.fromJson(formData);
    Response response = await externalTicketsProvider.createOneAndSave(data);
