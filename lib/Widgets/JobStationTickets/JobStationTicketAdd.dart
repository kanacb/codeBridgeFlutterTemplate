...
class JobStationTicketAdd extends StatefulWidget {
  const JobStationTicketAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<JobStationTicketAdd> createState() => _JobStationTicketAddState();
}

class _JobStationTicketAddState extends State<JobStationTicketAdd> {
  ...
  void saveForm() async {
    ...
    JobStationTicketProvider externalTicketProvider = JobStationTicketProvider();
