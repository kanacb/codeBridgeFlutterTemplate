...
class JobStationTicketEdit extends StatefulWidget {
  const JobStationTicketEdit({
    super.key,
  ...
  @override
  State<JobStationTicketEdit> createState() => _JobStationTicketEditState();
}

class _JobStationTicketEditState extends State<JobStationTicketEdit> {
  ...
  void saveForm() async {
    ...
    JobStationTicketProvider ticketProvider = JobStationTicketProvider();
    // Handle form submission logic here
    final data = JobStationTicket.fromJson(formData);
    Response response = await ticketProvider.updateOneAndSave(data.ticketId!, data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          "Edit Ticket - ${widget.ticket.ticketId}",
