...
class JobStationsAdd extends StatefulWidget {
  const JobStationsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<JobStationsAdd> createState() => _JobStationsAddState();
}

class _JobStationsAddState extends State<JobStationsAdd> {
  ...
  void saveForm() async {
    ...
    Response response = await jobStationsProvider.createOneAndSave(data);
    SnackBars snackBar = SnackBars();
    if (response.isSuccess) {
      snackBar.SuccessSnackBar(context, "Successfully created job Stations");
    } else {
      snackBar.FailedSnackBar(context, "Failed to create  job Stations");
    }
  }
