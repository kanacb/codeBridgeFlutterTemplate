...
class MachineMasterAdd extends StatefulWidget {
  const MachineMasterAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<MachineMasterAdd> createState() => _MachineMasterAddState();
}

class _MachineMasterAddState extends State<MachineMasterAdd> {
  ...
  void saveForm() async {
    ...
    MachineMasterProvider machineMasterProvider = MachineMasterProvider();
