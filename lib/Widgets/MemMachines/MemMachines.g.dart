...
part of 'MemMachines.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MemMachinesAdapter extends TypeAdapter<MemMachines> {
  @override
  final int typeId = 44;

  @override
  MemMachines read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, MemMachines obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.id)
