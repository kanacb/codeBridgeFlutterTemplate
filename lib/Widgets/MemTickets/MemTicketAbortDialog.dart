...
class MemTicketAbortDialog extends StatefulWidget {
  final MemTicket ticket;
  final VoidCallback onUpdated;
  final VoidCallback onHide;

  const MemTicketAbortDialog({
    super.key,
  ...
  @override
  State<MemTicketAbortDialog> createState() => _MemTicketAbortDialogState();
}

class _MemTicketAbortDialogState extends State<MemTicketAbortDialog> {
