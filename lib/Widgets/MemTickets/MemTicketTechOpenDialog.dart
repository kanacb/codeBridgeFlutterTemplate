...
class MemTicketTechOpenDialog extends StatefulWidget {
  final MemTicket ticket;
  final VoidCallback onUpdated;
  final VoidCallback onHide;

  const MemTicketTechOpenDialog({
    super.key,
  ...
  @override
  State<MemTicketTechOpenDialog> createState() => _MemTicketTechOpenDialogState();
}

class _MemTicketTechOpenDialogState extends State<MemTicketTechOpenDialog> {
