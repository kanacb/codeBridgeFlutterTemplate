...
class PartRequestDetailsEdit extends StatefulWidget {
  const PartRequestDetailsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final PartRequestDetails ticket;

  @override
  State<PartRequestDetailsEdit> createState() => _PartRequestDetailsEditState();
}

class _PartRequestDetailsEditState extends State<PartRequestDetailsEdit> {
  ...
  void saveForm() async {
    ...
    PartRequestDetailsProvider ticketProvider = PartRequestDetailsProvider();
