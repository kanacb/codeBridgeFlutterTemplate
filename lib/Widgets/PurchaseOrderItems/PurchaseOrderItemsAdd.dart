...
class PurchaseOrderItemsAdd extends StatefulWidget {
  const PurchaseOrderItemsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<PurchaseOrderItemsAdd> createState() => _PurchaseOrderItemsAddState();
}

class _PurchaseOrderItemsAddState extends State<PurchaseOrderItemsAdd> {
  ...
  void saveForm() async {
    ...
    PurchaseOrderItemsProvider externalTicketProvider = PurchaseOrderItemsProvider();
    // Handle form submission logic here
    final data = PurchaseOrderItems.fromJson(formData);
