...
class PurchaseOrderItemsEdit extends StatefulWidget {
  const PurchaseOrderItemsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final PurchaseOrderItems ticket;

  @override
  State<PurchaseOrderItemsEdit> createState() => _PurchaseOrderItemsEditState();
}

class _PurchaseOrderItemsEditState extends State<PurchaseOrderItemsEdit> {
  ...
  void saveForm() async {
    ...
    PurchaseOrderItemsProvider ticketProvider = PurchaseOrderItemsProvider();
