...
class QuotationItemsAdd extends StatefulWidget {
  const QuotationItemsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<QuotationItemsAdd> createState() => _QuotationItemsAddState();
}

class _QuotationItemsAddState extends State<QuotationItemsAdd> {
  ...
  void saveForm() async {
    ...
    QuotationItemsProvider externalTicketProvider = QuotationItemsProvider();
    // Handle form submission logic here
    final data = QuotationItems.fromJson(formData);
