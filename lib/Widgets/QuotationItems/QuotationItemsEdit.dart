...
class QuotationItemsEdit extends StatefulWidget {
  const QuotationItemsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final QuotationItems ticket;

  @override
  State<QuotationItemsEdit> createState() => _QuotationItemsEditState();
}

class _QuotationItemsEditState extends State<QuotationItemsEdit> {
  ...
  void saveForm() async {
    ...
    QuotationItemsProvider ticketProvider = QuotationItemsProvider();
