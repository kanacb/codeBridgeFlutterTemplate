...
class SalesOrderItemsAdd extends StatefulWidget {
  const SalesOrderItemsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<SalesOrderItemsAdd> createState() => _SalesOrderItemsAddState();
}

class _SalesOrderItemsAddState extends State<SalesOrderItemsAdd> {
  ...
  void saveForm() async {
    ...
    SalesOrderItemsProvider externalTicketProvider = SalesOrderItemsProvider();
    // Handle form submission logic here
    final data = SalesOrderItems.fromJson(formData);
