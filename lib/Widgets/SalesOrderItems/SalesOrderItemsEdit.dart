...
class SalesOrderItemsEdit extends StatefulWidget {
  const SalesOrderItemsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final SalesOrderItems ticket;

  @override
  State<SalesOrderItemsEdit> createState() => _SalesOrderItemsEditState();
}

class _SalesOrderItemsEditState extends State<SalesOrderItemsEdit> {
  ...
  void saveForm() async {
    ...
    SalesOrderItemsProvider ticketProvider = SalesOrderItemsProvider();
