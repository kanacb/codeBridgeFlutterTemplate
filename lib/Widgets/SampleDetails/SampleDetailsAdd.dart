...
class SampleDetailsAdd extends StatefulWidget {
  const SampleDetailsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<SampleDetailsAdd> createState() => _SampleDetailsAddState();
}

class _SampleDetailsAddState extends State<SampleDetailsAdd> {
  ...
  void saveForm() async {
    ...
    SampleDetailsProvider externalTicketProvider = SampleDetailsProvider();
