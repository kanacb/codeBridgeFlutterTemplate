...
class StockInDetailsAdd extends StatefulWidget {
  const StockInDetailsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<StockInDetailsAdd> createState() => _StockInDetailsAddState();
}

class _StockInDetailsAddState extends State<StockInDetailsAdd> {
  ...
  void saveForm() async {
    ...
    StockInDetailsProvider externalTicketProvider = StockInDetailsProvider();
    // Handle form submission logic here
    final data = StockInDetails.fromJson(formData);
