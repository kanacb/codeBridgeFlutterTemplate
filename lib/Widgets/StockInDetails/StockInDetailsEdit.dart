...
class StockInDetailsEdit extends StatefulWidget {
  const StockInDetailsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final StockInDetails ticket;

  @override
  State<StockInDetailsEdit> createState() => _StockInDetailsEditState();
}

class _StockInDetailsEditState extends State<StockInDetailsEdit> {
  ...
  void saveForm() async {
    ...
    StockInDetailsProvider ticketProvider = StockInDetailsProvider();
