...
class StockOutDetailsAdd extends StatefulWidget {
  const StockOutDetailsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<StockOutDetailsAdd> createState() => _StockOutDetailsAddState();
}

class _StockOutDetailsAddState extends State<StockOutDetailsAdd> {
  ...
  void saveForm() async {
    ...
    StockOutDetailsProvider externalTicketProvider = StockOutDetailsProvider();
    // Handle form submission logic here
    final data = StockOutDetails.fromJson(formData);
