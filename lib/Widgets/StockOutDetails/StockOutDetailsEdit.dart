...
class StockOutDetailsEdit extends StatefulWidget {
  const StockOutDetailsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final StockOutDetails ticket;

  @override
  State<StockOutDetailsEdit> createState() => _StockOutDetailsEditState();
}

class _StockOutDetailsEditState extends State<StockOutDetailsEdit> {
  ...
  void saveForm() async {
    ...
    StockOutDetailsProvider ticketProvider = StockOutDetailsProvider();
