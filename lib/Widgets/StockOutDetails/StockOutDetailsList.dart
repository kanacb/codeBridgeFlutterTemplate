...
import 'StockOutDetailsAdd.dart';
import 'StockOutDetailsEdit.dart';
import 'StockOutDetailsProvider.dart';

class StockOutDetailsList extends StatefulWidget {
  const StockOutDetailsList({super.key});

  @override
  State<StockOutDetailsList> createState() => _StockOutDetailsListState();
}

class _StockOutDetailsListState extends State<StockOutDetailsList> {
  ...
  Widget build(BuildContext context) {
    final ticketProvider = Provider.of<StockOutDetailsProvider>(context);
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(Utils().createRoute(
                  context, StockOutDetailsAdd(resource: schemaResponse?.data)));
            },
  ...
  Widget _buildTicketList(List<StockOutDetails> tickets) {
  ...
  Widget _buildTicketCard(StockOutDetails ticket, int index) {
    return Card(
      margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
      child: Column(
        children: [
          ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                Text('Stock Out Type: ${ticket.stockOutType}'),
                Text('Associated Order Number: ${ticket.associatedOrderNumber}'),
                Text('Condition of Items: ${ticket.conditionOfItems}'),
