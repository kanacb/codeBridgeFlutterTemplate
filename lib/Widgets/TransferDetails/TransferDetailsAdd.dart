...
class TransferDetailsAdd extends StatefulWidget {
  const TransferDetailsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<TransferDetailsAdd> createState() => _TransferDetailsAddState();
}

class _TransferDetailsAddState extends State<TransferDetailsAdd> {
  ...
  void saveForm() async {
    ...
    TransferDetailsProvider externalTicketProvider = TransferDetailsProvider();
    // Handle form submission logic here
    final data = TransferDetails.fromJson(formData);
