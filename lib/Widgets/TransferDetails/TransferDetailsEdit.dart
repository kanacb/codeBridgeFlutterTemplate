...
class TransferDetailsEdit extends StatefulWidget {
  const TransferDetailsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final TransferDetails ticket;

  @override
  State<TransferDetailsEdit> createState() => _TransferDetailsEditState();
}

class _TransferDetailsEditState extends State<TransferDetailsEdit> {
  ...
  void saveForm() async {
    ...
    TransferDetailsProvider ticketProvider = TransferDetailsProvider();
