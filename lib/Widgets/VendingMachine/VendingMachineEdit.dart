...
class VendingMachineEdit extends StatefulWidget {
  ...
  @override
  State<VendingMachineEdit> createState() => _VendingMachineEditState();
}

class _VendingMachineEditState extends State<VendingMachineEdit> {
  ...
  void initState() {
    super.initState();
    dynamic initialValue = widget.vm.toJson();
  ...
  void saveForm() async {
    ...
    VendingMachineProvider machineProvider = VendingMachineProvider();
    // Handle form submission logic here
    final data = VendingMachine.fromJson(formData);
    Response response =
    await machineProvider.updateOneAndSave(data.id!, data);
