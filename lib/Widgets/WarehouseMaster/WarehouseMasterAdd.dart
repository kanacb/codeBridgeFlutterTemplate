...
class WarehouseMasterAdd extends StatefulWidget {
  const WarehouseMasterAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<WarehouseMasterAdd> createState() => _WarehouseMasterAddState();
}

class _WarehouseMasterAddState extends State<WarehouseMasterAdd> {
  ...
  void saveForm() async {
    ...
    WarehouseMasterProvider externalTicketProvider = WarehouseMasterProvider();
