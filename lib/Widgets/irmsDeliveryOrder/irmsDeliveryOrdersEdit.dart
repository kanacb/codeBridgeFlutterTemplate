...
class irmsDeliveryOrdersEdit extends StatefulWidget {
  const irmsDeliveryOrdersEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final irmsDeliveryOrders ticket;

  @override
  State<irmsDeliveryOrdersEdit> createState() => _irmsDeliveryOrdersEditState();
}

class _irmsDeliveryOrdersEditState extends State<irmsDeliveryOrdersEdit> {
  ...
  void saveForm() async {
    ...
    irmsDeliveryOrdersProvider ticketProvider = irmsDeliveryOrdersProvider();
