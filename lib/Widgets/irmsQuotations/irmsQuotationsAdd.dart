...
class irmsQuotationsAdd extends StatefulWidget {
  const irmsQuotationsAdd({super.key, required this.resource});
  final List<Schema> resource;

  @override
  State<irmsQuotationsAdd> createState() => _irmsQuotationsAddState();
}

class _irmsQuotationsAddState extends State<irmsQuotationsAdd> {
  ...
  void saveForm() async {
    ...
    irmsQuotationsProvider externalTicketProvider = irmsQuotationsProvider();
    // Handle form submission logic here
    final data = irmsQuotations.fromJson(formData);
