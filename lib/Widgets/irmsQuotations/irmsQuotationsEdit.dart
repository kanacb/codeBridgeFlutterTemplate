...
class irmsQuotationsEdit extends StatefulWidget {
  const irmsQuotationsEdit({
    super.key,
    required this.resource,
    required this.ticket, required jobStationTicket,
  });
  final List<Schema> resource;
  final irmsQuotations ticket;

  @override
  State<irmsQuotationsEdit> createState() => _irmsQuotationsEditState();
}

class _irmsQuotationsEditState extends State<irmsQuotationsEdit> {
  ...
  void saveForm() async {
    ...
    irmsQuotationsProvider ticketProvider = irmsQuotationsProvider();
